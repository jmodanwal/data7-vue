<template>
  <section id="counter" class="section bg-light pt-5">
    <div class="container">
      <div class="row" id="usp">
        ...
        <div class="col-lg-7">
          <div class="row">
            <div class="col-lg-6" v-for="(usp, i) in usp" :key="i">
              <div class="counter-box mt-4">
                <div class="media box-shadow bg-white p-4 rounded">
                  <div class="counter-icon mr-3">
                    <i :class="'mdi '+usp.icon+' text-primary h2'"></i>
                  </div>
                  <div class="media-body pl-2">
                    <h5 class="mt-2 mb-0 f-17">{{usp.title}}</h5>
                    <p class="text-muted mb-0 mt-2 f-15">{{usp.description}}</p>
                  </div>
                </div>
              </div>
            </div>
